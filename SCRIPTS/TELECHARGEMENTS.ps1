...
$bdd_codes | ForEach-Object {
	...
	" > $bdd_nom"
	 ...
	 # Vérifier le statut des différentes URLs
    if (($bdd_nom -eq "INPN" -and $INPN_url.StatusCode -ne "OK") -or
        ($bdd_nom -eq "INATURALIST" -and $INATURALIST_url.StatusCode -ne "OK") -or
        ($bdd_nom -eq "OBSERVATION" -and $OBSERVATION_url.StatusCode -ne "OK") -or
        ($bdd_nom -eq "GBIF" -and $GBIF_url.StatusCode -ne "OK") -or
        ($bdd_nom -eq "FAUNE-FRANCE" -and $FF_url.StatusCode -ne "OK")) {
