window.onload = function go() {
	...
	var createMap = function () {
		...
		var layer_osm = new ol.layer.Tile({
			...
			'<span style="color:#b70000; font-weight:bold">Version en développement</span> | <a href="https://github.com/CigalesdeFrance/CARTES/">Code source/Erreurs</a> | © <a href="https://www.cigalesdefrance.fr">Cigales de France</a> |',ol.source.OSM.ATTRIBUTION,'<br><a href="https://inpn.mnhn.fr"><img class="copyright" src="https://cartes.cigalesdefrance.fr/ASSETS/LOGOS/INPN.png" alt="Logo de l\'INPN"></a><a href="https://observation.org"><img class="copyright" src="https://cartes.cigalesdefrance.fr/ASSETS/LOGOS/OBSERVATION.svg" alt="Logo d\'Observation.org"></a><a href="https://www.gbif.org"><img class="copyright" src="https://cartes.cigalesdefrance.fr/ASSETS/LOGOS/GBIF.svg" alt="Logo de GBIF"></a><a href="https://www.inaturalist.org/"><img class="copyright" src="https://cartes.cigalesdefrance.fr/ASSETS/LOGOS/INATURALIST.svg" alt="Logo d\'iNaturalist"></a><a href="https://www.faune-france.org/"><img src="https://cartes.cigalesdefrance.fr/ASSETS/LOGOS/FAUNE-FRANCE.png" alt="Logo de Faune-France"></a>']}),
			opacity: 1
		});
