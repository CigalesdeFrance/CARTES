window.onload = function go() {
	...
	var layer_osm = new ol.layer.Tile({
		...
		'<span style="color:#b70000; font-weight:bold">Version bêta</span> | <a href="https://github.com/CigalesdeFrance/CARTES/">Code source/Erreurs</a> | © <a href="https://www.cigalesdefrance.fr">Cigales de France</a> |',ol.source.OSM.ATTRIBUTION,'<br><a href="https://inpn.mnhn.fr"><img class="copyright" src="https://inpn.mnhn.fr/css/images_template/logo_inpn.png" alt="Logo de l\'INPN"></a><a href="https://observation.org"><img class="copyright" src="https://observation.org/static/img/logo/logo-observation-org.svg" alt="Logo d\'Observation.org"></a><a href="https://www.gbif.org"><img class="copyright" src="https://docs.gbif.org/style/logo.svg" alt="Logo de GBIF"></a><a href="https://www.inaturalist.org/"><img class="copyright" src="https://static.inaturalist.org/sites/1-logo.svg" alt="Logo d\'iNaturalist"></a>']}),
		opacity: 1
	});
